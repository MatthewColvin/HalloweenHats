...
uint8_t john[] = {0x08, 0x3a, 0x8d, 0xd4, 0x01, 0x73};
uint8_t katie[] = {0x24, 0xD7, 0xEB, 0xCA, 0x66, 0x22};

uint8_t matt[] = {0x24, 0xD7, 0xEB, 0xCA, 0x8A, 0xCA};
uint8_t zach[] = {0x08, 0x3a, 0x8d, 0xd4, 0x25, 0x0d};

uint8_t nathan[] = {0x24, 0xD7, 0xEB, 0xCA, 0x79, 0xfe};
uint8_t dan[] = {0x08, 0x3a, 0x8d, 0xd4, 0x07, 0x7a};

uint8_t sam[] = {0x08, 0x3a, 0x8d, 0xd4, 0x26, 0xf8};
uint8_t kristin[] = {0x08, 0x3a, 0x8d, 0xd3, 0xfe, 0xd9};

uint8_t *buddyAddress = kristin;
